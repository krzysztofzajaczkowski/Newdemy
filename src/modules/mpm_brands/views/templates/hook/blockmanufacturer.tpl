<div id="manufacturers_block_left" class="block blockmanufacturer block-left-column">
	...
	<div onclick="" class="title_block title-block-left-column"> <a class="title_left_column" href="{$link|escape:'htmlall':'UTF-8'}" title="{l s='Brands' mod='mpm_brands'}">{l s='Brands' mod='mpm_brands'}</a> </div>
			...
			<ul class="bullet ">
				{foreach $manufacturers as $manufacturer}
					<li class="manufacturer_item">
						<a href="{$manufacturer['link']|escape:'htmlall':'UTF-8'}" title="{l s='More about %s' sprintf=[$manufacturer.name|escape:'htmlall':'UTF-8'] mod='mpm_brands'}">
