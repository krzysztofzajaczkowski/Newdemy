<div id="suppliers_block_left" class="block blocksupplier block-left-column">
	<div onclick="" class="title_block title-block-left-column">
		<a class="title_left_column" href="{$link|escape:'htmlall':'UTF-8'}" title="{l s='Suppliers' mod='mpm_suppliers'}">{l s='Suppliers' mod='mpm_suppliers'}</a>
	</div>
		...
		<ul class="bullet">
			{foreach $suppliers as $supplier}
				<li class="item_supplie">
					<a href="{$supplier['link']|escape:'htmlall':'UTF-8'}" title="{l s='More about' mod='mpm_suppliers'} {$supplier.name|escape:'htmlall':'UTF-8'}">
