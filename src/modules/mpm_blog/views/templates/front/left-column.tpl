  {if $settings['show_search']}
    <div class="block block_search block-left-column">
      <div class="title_block title-block-left-column"><span class="title_left_column">{l s='Search on Blog'  mod='mpm_blog'}</span></div>
  ...
  {if $settings['show_categories']}
    <div class="block block_categories block-left-column">
      <div class="title_block title-block-left-column"><span class="title_left_column">{l s='Blog Categories'  mod='mpm_blog'}</span></div>
      <div class="left-column-arrows">
        <span class="column-arrows-add active"  onclick=""><i class="material-icons">add</i></span>
        <span class="column-arrows-remove"  onclick=""><i class="material-icons">remove</i></span>
      </div>
  ...
  {if isset($settings['show_archive']) && $settings['show_archive']}
    <div class="block block_archive block-left-column">
      <div class="title_block title-block-left-column"><span class="title_left_column">{l s='Blog Archive'  mod='mpm_blog'}</span></div>
      <div class="left-column-arrows">
        <span class="column-arrows-add active"  onclick=""><i class="material-icons">add</i></span>
        <span class="column-arrows-remove"  onclick=""><i class="material-icons">remove</i></span>
      </div>
  ...
  {if isset($settings['show_tags']) && $settings['show_tags'] && count($most_tags)}
    <div class="block block_tags block-left-column">
      <div class="title_block title-block-left-column"><span class="title_left_column">{l s='Tags'  mod='mpm_blog'}</span></div>
      <div class="left-column-arrows">
        <span class="column-arrows-add active"  onclick=""><i class="material-icons">add</i></span>
        <span class="column-arrows-remove"  onclick=""><i class="material-icons">remove</i></span>
      </div>
  ...
  {if isset($settings['featured_posts']) && $settings['featured_posts'] && count($featured)}
    <div class="block block_featured block-left-column">
      <div class="title_block title-block-left-column" id="title_block_blog">
        <span class="title_left_column">{l s='Featured articles'  mod='mpm_blog'}</span>
