...
class Leofeature extends Module
{
    ...
    public function getContent()
    {
        ...
        return Leofeature::freeText().$this->html.Leofeature::freeText();
    }
...
//            return $this->fetch('module:leofeature/views/templates/hook/leo_list_product_review.tpl', Tools::getValue('search_query') ? null : $this->getCacheId());
    ...
    public static function freeText()
    {
        ...
        . '<a target="_blank" href="http://leotheme.com" title="professional version">Please click here to find out about professional version and how to update to this version</a></marquee></div>';
    }
