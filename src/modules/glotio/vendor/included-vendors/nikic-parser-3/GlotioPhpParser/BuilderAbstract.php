...
use GlotioPhpParser\Comment;
use GlotioPhpParser\Node\Expr;
use GlotioPhpParser\Node\Name;
use GlotioPhpParser\Node\NullableType;
use GlotioPhpParser\Node\Scalar;
...
abstract class BuilderAbstract implements Builder {
    ...
    /**
     * Normalizes a name: Converts plain string names to GlotioPhpParser\Node\Name.
     *
    ...
    protected function normalizeName($name) {
        ...
        throw new \LogicException('Name must be a string or an instance of GlotioPhpParser\Node\Name');
    }
    ...
    /**
     * Normalizes a doc comment: Converts plain strings to GlotioPhpParser\Comment\Doc.
     *
    ...
    protected function normalizeDocComment($docComment) {
        if ($docComment instanceof Comment\Doc) {
            ...
            throw new \LogicException('Doc comment must be a string or an instance of GlotioPhpParser\Comment\Doc');
        }
    }
