...
class mpm_homefeatured extends Module
{
  ...
  private function _setDataDb(){
    ...
    $data = array(
      array('type' => 'all', 'hook' => 'displayHomeContent2', 'title' => 'Featured Products'),
    );
  ...
  {
    $this->context->controller->registerStylesheet('mpm_homefeatured1', 'modules/'.$this->name.'/views/css/mpm_homefeatured.css',  array('media' => 'all', 'priority' => 900));
    $this->context->controller->registerStylesheet('slick', 'modules/'.$this->name.'/views/css/slick.css',  array('media' => 'all', 'priority' => 900));
    $this->context->controller->registerJavascript('mpm_homefeatured1', 'modules/'.$this->name.'/views/js/mpm_homefeatured.js',  array('position' => 'bottom', 'priority' => 150));
