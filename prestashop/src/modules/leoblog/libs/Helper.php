...
class LeoBlogHelper
{
    ...
    public static function freeText()
    {
        ...
        . '<a target="_blank" href="https://www.leotheme.com/module/prestashop-modules/613-leo-blog-module.html" title="professional version">Please click here to find out about professional version and how to update to this version</a></marquee></div>';
    }
    
    const FREE_LIMIT_BLOG = 8;
