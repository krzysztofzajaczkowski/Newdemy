				...
				<article class="blog-detail">
					{if $is_active}
							...
							<div class="share_button">
								...
								<ul>
									{if Configuration::get('LEOBLOG_SHARE_FB')}
										<li class="facebook">
											<a href="http://www.facebook.com/sharer.php?u={$smarty.server.HTTP_HOST}{$smarty.server.REQUEST_URI}">
									...
									{if Configuration::get('LEOBLOG_SHARE_TW')}
										<li class="twitter">
											<a href="https://twitter.com/intent/tweet?text={$smarty.server.HTTP_HOST}{$smarty.server.REQUEST_URI}">
						...
						<div class="social-share">
							 {include file="module:leoblog/views/templates/front/{$module_tpl}/_social.tpl"}
						</div>
						{if $tags}
						<div class="blog-tags">
						...
						{if $config->get('item_show_listcomment','1') == 1}
							<div class="blog-comment-block clearfix">
								{if $config->get('item_comment_engine','local')=='facebook'}
									{include file="module:leoblog/views/templates/front/{$module_tpl}/_facebook_comment.tpl"}
								{elseif $config->get('item_comment_engine','local')=='diquis'}
									{include file="module:leoblog/views/templates/front/{$module_tpl}/_diquis_comment.tpl"}
								
								{else}
									{include file="module:leoblog/views/templates/front/{$module_tpl}/_local_comment.tpl"}
								{/if}
